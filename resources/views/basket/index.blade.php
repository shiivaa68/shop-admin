                                ...
                                <div class="col-sm-6">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" checked="checked" name="ارسال رایگان">
                          ...
                          <input type="submit" class="btn btn-primary" data-loading-text="بارگذاری ..." id="button-voucher" value="اعمال کارت هدیه">
                                ...
                                <div class="col-sm-12">
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <td class="text-center"><a href="product.html"><img src="{{$basket->product->image}}" alt="کفش راحتی مردانه" title="کفش راحتی مردانه" class="img-thumbnail"></a></td>
                                    ...
                                    <button type="button" data-toggle="tooltip" title="حذف" class="btn btn-danger" onClick=""><i class="fa fa-times-circle"></i></button>
                                                        ...
                                                        <td class="text-right">{{$basket->price*$basket->count}} تومان</td>
                                                    </tr>
                                                        @endforeach
                                                        @endif
                                                    </tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{(($sum)/100)*9}}} تومان</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-right" colspan="4"><strong>کل :</strong></td>
                                                        <td class="text-right">{{$sum+(($sum)/100)*9}} تومان</td>
                                                    </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
